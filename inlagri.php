...
<body>
    ...
    <div class="container-fluid">
    	<img src="images/banner3.jpg" style="width: 103%; max-height: 300; margin-left:-15px;">
    </div><br><br>

 <!-- A VIDEO AND A POSTER-->
<div class="container">
	<div class="col-sm-4">
     <iframe width="350" height="250" src="https://www.youtube.com/embed/fxhrqG0eQno" frameborder="0" allowfullscreen></iframe>
    </div>
  	<div class="col-sm-4">
  		<iframe width="350" height="250" src="https://www.youtube.com/embed/oxxYmn3HpDU" frameborder="0" allowfullscreen></iframe>
  	</div>
  	<div class="col-sm-4">
		<iframe width="350" height="250" src="https://www.youtube.com/embed/dvBHGS1ZjF0" frameborder="0" allowfullscreen></iframe>
    </div>
</div><br><br><br>
<!--FIN-->
