      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav navbar-right">
           ...
           <ul class="nav navbar-nav navbar-right">
            <ul class="nav navbar-nav navbar-right">
              <li class=""><a href="siginup.php"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
              <li class=""><a href="signinup.php"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
            </ul>            
            </ul>
          </ul>
        </div>
