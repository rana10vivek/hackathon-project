...
<?php
			...
			$sql = "SELECT * FROM coursesdetails WHERE dropdown='Tourism and Hospitality'";
			...
			// output data of each row
				...
				echo "<br><br> <br><b><strong>Courses Name: </b>" .  $row["CourseName"]. "<br></strong><br /><b> Name: </b>" . $row["Name"]. "<br /><b> Eligibility: </b>" . $row["Eligibility"]. "<br /><b> Experience:</b> " . $row["Experience"].
				"<br /><b> Terminal Competency:</b> " . $row["TerminalCompetency"]. "<br /><b> Duration:</b> " . $row["Duration"]. "<br /><b> Content Offerings:</b> " . $row["ContentOfferings"].
				"<br /><b> Content Availability in Regional Languages:</b> " . $row["ContentAvailabilityinRegionalLanguages"]. "<br /><b> Special Feature:</b> " . $row["SpecialFeature"];
			}  ?></p></div><br><?php
			} else {
				echo "0 results";
			}
