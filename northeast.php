...
<?php
			...
			$sql = "SELECT * FROM colleges_zonewise WHERE ZONE='NORTH EAST'";
			...
			// output data of each row
				...
				echo "<br><br> <br><b>College Name: </b>" .  $row["CollegeName"]. "<br><br /><b> State: </b>" . $row["State"]. "<br /><b> Website: </b>" . $row["Website"]. "<br /><b> Courses:</b> " . $row["Courses"].
				"<br /><b> Duration:</b> " . $row["Duration"]. "<br /><b> About:</b> " . $row["About"]. "<br /><b> Zone:</b> " . $row["ZONE"];
			}
			} else {
				echo "0 results";
			}
