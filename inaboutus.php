      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class=""><a href="inaboutus.php">ABOUT US</a></li>
...
<!--TEXT OVERLAY ON AN IMAGE-->
    <div class="row" id="box-search">
      <div class="thumbnail text-center">
        <img src="images/aboutbanner.jpg" height="1000px" width="2000px" alt="" class="img-responsive">
        <div class="caption">
          <strong><h2 style="color:#133990"><p>VOCA</p></h2></strong>
        <!--  <form class="form-inline">
            <div class="input-group">
              <input type="text" class="form-control" size="50" placeholder="Search in Voca" required>
    ...
    <div class="container-fluid bg-grey">
      <div class="row">
        <div class="col-sm-4" style="margin: 140px 0px 0px 110px;">
          <img src="images/topi.jpg" height="300" width="300" class="img-responsive">
        </div>
        <div class="col-sm-7" style="margin-left: -80px; margin-bottom: 10px;">
          <h2><font color="#133990">ABOUT US</font></h2><br>
          
          <p>Voca.com is a one-stop-solution making course and college selection easy for students looking to pursue vocational courses in India; also accessible to users on the move through the website. Launched in 2017, Voca.com belongs to Ministry of Skill Development and Entrepreneurship.Voca offers its users the unique privilege of customised test and constantly updated news.

                    Our website is a repository of reliable and authentic information for large number of institutions, and many courses.It has a registered data base of and for students. We offer specific information for students interested in vocational courses in India and across the most popular educational streams – Management; Banking & Finance; Animation, VFX, Gaming & Comics; Hospitality, Aviation & Tourism; Media, Films & Mass Communication; Design; Medicine, Beauty & Health Care; Retail; Arts, Languages & Teaching; and Test Preparation.

          Education seekers get a personalised experience on our site, based on educational background and career interest, enabling them to make well informed course and college decisions. The decision making is empowered with easy access to detailed information on career choices, courses, exams, colleges, admission criteria, eligibility, fees, placement statistics, rankings, reviews, scholarships, latest updates etc as well as by interacting with other Voca.com users, experts.

          Our active ask and answer community has over 1000 experts answering career and college related queries. Students can ask questions, participate in discussions and stay updated with latest news, articles related to their education interest. Voca.com is upcoming India’s smartest college gateway that blends higher education related domain knowledge, with technology, innovation, and credibility to give students personalised insights to make informed career, course and college decisions.</p>
        </div>
      </div>
    </div>
