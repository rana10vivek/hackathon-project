...
<!--TEXT OVERLAY ON AN IMAGE-->
    <div class="row" id="box-search">
      <div class="thumbnail text-center">
        <img src="images/userbanner.jpg" height="1000px" width="2000px" alt="" class="img-responsive">
        <div class="caption">
          <strong><h2><b><p>VOCA</p></b></h2></strong>
  ...
  <div class="w3-row-padding" id="about">
    ...
    <div class="w3-third w3-margin-bottom">
      <div class="w3-card-4">
        <center><img src="images/cyborggal.png" alt="" style="width: 300px; height: 300px;"></center>
        <div class="w3-container">
          <h3>Himanshi Goyat</h3>
          <p class="w3-opacity">Web Designer</p>
          <p>Member of Cyborgs.</p>
    ...
    <div class="w3-third w3-margin-bottom">
      <div class="w3-card-4">
       <center> <img src="images/cyborgguy.png" alt="" style="width: 300px; height: 300px;"></center>
        <div class="w3-container">
          <h3>Rocktim Vijay Rajkhowa</h3>
...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: 'gu,hi,pa,ta,te', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
     ...
     <a href="incyborg.php"> <p>Designed by <strong><u>CYBORGS</u></strong></p> </a>
    </footer>
